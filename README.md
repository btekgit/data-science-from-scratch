Data Science from Scratch Fork for CSE485 Course
=========================
I aim to use the books original code as the base to develop code for CSE485 Data Mining Course.
See the Joel's original [page](https://github.com/joelgrus/data-science-from-scratch) for the original code. 
## Table of Contents
